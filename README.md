...
git commit -m "Gestionnaire de mots de passe — version initiale"
git branch -M main
git remote add origin https://github.com/VOTRE_UTILISATEUR/Gestionnaire_mdp.git
git push -u origin main
```

Créez d’abord un dépôt vide sur GitHub, puis remplacez l’URL par la vôtre.

## Licence

Projet personnel — précisez ici la licence choisie (par ex. MIT) si vous souhaitez autoriser la réutilisation du code.
